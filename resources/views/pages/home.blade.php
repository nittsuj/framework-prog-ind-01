        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a class="btn btn-primary btn-lg px-4" href="{{ route('agent', 'K3-Laboratorium') }}"><i class="bi bi-arrow-up-right-circle me-2"></i>Jelajahi proyek AI</a>
                    <a class="btn btn-outline-dark btn-lg px-4" href="{{ route('mahasiswa', $studentNrp) }}">Lihat profil</a>
                </div>
            ...
            <div class="col-lg-5">
                <div class="profile-panel position-relative">
                    ...
                    <h2 class="h3 fw-bold">{{ $studentName }}</h2>
